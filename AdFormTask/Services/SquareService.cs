...
namespace AdFormTask.Services
{
    ...
    {
        public string FormatPointString(string pointsString)
        {
        ...
        public List<Point> GetPoints(string[] coordinates)
        {
        ...
        public bool IsSquare(Point point1, Point point2, Point point3, Point point4)
        {
            bool isSquare = false;
        ...
        public int PointsDistance(Point point1, Point point2)
        {
